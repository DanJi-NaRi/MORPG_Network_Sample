...
- Scope impact: Prerequisite login-to-world smoke: Required binaries were not present under Bin/, so smoke_world_enter.ps1 could not be executed from this workspace.

## Next Actions
- Build YunoLoginServer and YunoServer first, then rerun the smoke and integration scripts.
