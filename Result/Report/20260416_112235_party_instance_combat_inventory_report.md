...
- powershell.exe -ExecutionPolicy Bypass -File C:\Project\MORPG_Network_Sample\.omx\team\omx-plans-prd-morpg-demo-serve\worktrees\worker-1\scripts\build_and_test.ps1 -Configuration Debug -Platform x64 -Targets YunoNetProtocol,YunoGameProtocol,YunoLoginServer,YunoServer
- powershell.exe -ExecutionPolicy Bypass -File C:\Project\MORPG_Network_Sample\.omx\team\omx-plans-prd-morpg-demo-serve\worktrees\worker-1\scripts\smoke_world_enter.ps1 -Configuration Debug -Platform x64 -LoginPort 7000 -WorldPort 9000 -WarmupSeconds 3
