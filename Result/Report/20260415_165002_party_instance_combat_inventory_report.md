...
- powershell.exe -ExecutionPolicy Bypass -File C:\project\morpg_network_sample\.omx\team\execute-omx-plans-prd-morpg-de\worktrees\worker-2\scripts\build_and_test.ps1 -Configuration Debug -Platform x64 -Targets YunoNetProtocol,YunoGameProtocol,YunoLoginServer,YunoServer
...
## Next Actions
- Run smoke_world_enter.ps1 with YUNO_DB_* configured to validate the login -> town prerequisite end-to-end.
